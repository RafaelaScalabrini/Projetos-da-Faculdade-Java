...
Begin VB.Form frmControle 
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   -60
      Width           =   19170
      Begin VB.Timer TimerJogadorPontuol 
         Left            =   375
         Top             =   1605
      End
      ...
      Begin VB.Frame Frame11 
         ...
         Top             =   780
         Width           =   5850
         Begin MSAdodcLib.Adodc AdodcFlash 
            Height          =   435
            Left            =   705
            Top             =   510
            Visible         =   0   'False
            ...
            Orientation     =   0
            Enabled         =   -1
            Connect         =   "Provider=SQLOLEDB.1;Persist Security Info=False;User ID=placar;Initial Catalog=dbplacar;Data Source=pc-fabio-movel\sqlexpress"
            OLEDBString     =   "Provider=SQLOLEDB.1;Persist Security Info=False;User ID=placar;Initial Catalog=dbplacar;Data Source=pc-fabio-movel\sqlexpress"
            OLEDBFile       =   ""
            DataSourceName  =   ""
            OtherAttributes =   ""
            UserName        =   ""
...
Private Sub TimeAJogadoresUpDownPontos1_UpClick()
    ...
    'CONTROLE DA EXIBIÇÃO DO FLASH
        
    AdodcFlash.RecordSource = "SELECT"
